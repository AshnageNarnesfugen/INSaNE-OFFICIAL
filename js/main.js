        ...
        class LazyImageLoader {
            ...
            loadImages() {
              ...
              images.each((index, img) => {
                ...
                const dataModule = $(img).data('module');
            ...
            lazyLoadImage(imgElement) {
              const imageUrl = $(imgElement).data('src'); // Use data-src attribute instead of src
              ...
              return new Promise((resolve, reject) => {
                $.ajax({
                  ...
                  success: function(response) {
                    $(imgElement).attr('src', URL.createObjectURL(response));
                    resolve();
                  },
