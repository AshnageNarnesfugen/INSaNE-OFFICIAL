                    ...
                    for (const [key, value] of Object.entries(this.langCases)) {
                        if (key === language) {
                            $.getJSON('https://ipapi.co/json/')
                                ...
                                .fail(() => console.warn('[CookieManager] Could not fetch country.'));
                            return;
                        }
                    }
        ...
        if (isEU) {
            ...
            $('body').cookieBanner({
                ...
                customLangMessages: {
                    ...
                    es: { message: 'Usamos cookies para mejorar su experiencia. Al continuar visitando este sitio, acepta nuestro uso de cookies.', buttonText: 'Estoy de acuerdo', rejectText: 'Yo rechazo', policyLink: '/politica-de-privacidad', policyText: 'Aprende más sobre nuestra política de cookies' },
                    jp: { message: '私たちはあなたの経験を向上させるためにクッキーを使用します。', buttonText: '同意する', rejectText: '拒否する', policyLink: '/puraibashi-porishi', policyText: '私たちのクッキーポリシーについて詳しく知る' },
                    pt: { message: 'Usamos cookies para melhorar sua experiência. Ao continuar a visitar este site, você concorda com o uso de nossos cookies.', buttonText: 'Eu concordo', rejectText: 'Eu rejeito', policyLink: '/politica-de-privacidade', policyText: 'Saiba mais sobre nossa política de cookies' },
                    fr: { message: 'Nous utilisons des cookies pour améliorer votre expérience. En continuant à visiter ce site, vous acceptez notre utilisation des cookies.', buttonText: "Je suis d'accord", rejectText: 'Je refuse', policyLink: '/politique-de-confidentialite', policyText: 'En savoir plus sur notre politique de cookies' },
                    de: { message: 'Wir verwenden Cookies, um Ihre Erfahrung zu verbessern.', buttonText: 'Ich stimme zu', rejectText: 'Ich lehne ab', policyLink: '/datenschutz-bestimmungen', policyText: 'Erfahren Sie mehr über unsere Cookie-Richtlinie' },
                    it: { message: 'Utilizziamo i cookie per migliorare la tua esperienza.', buttonText: "Sono d'accordo", rejectText: 'Rifiuto', policyLink: '/politica-sulla-privacy', policyText: 'Per saperne di più sulla nostra politica sui cookie' },
                    ru: { message: 'Мы используем куки-файлы для улучшения вашего опыта.', buttonText: 'Я согласен', rejectText: 'Я отказываюсь', policyLink: '/politika-konfidentsialnosti', policyText: 'Узнайте больше о нашей политике' },
                    zh: { message: '我们使用cookies来提高您的体验。', buttonText: '我同意', rejectText: '我拒绝', policyLink: '/yinsi-zhengce', policyText: '了解更多关于我们的Cookie政策' },
                    kr: { message: '우리는 쿠키를 사용합니다.', buttonText: '동의합니다', rejectText: '거절합니다', policyLink: '/gaeinjeongbocheolibangchim', policyText: '우리의 쿠키 정책에 대해 더 알아보기' },
                    ar: { message: 'نستخدم ملفات تعريف الارتباط لتعزيز تجربتك.', buttonText: 'أوافق', rejectText: 'أرفض', policyLink: '/siasatu-alkhususia', policyText: 'تعرف على المزيد حول سياسة ملفات تعريف الارتباط' },
                    hi: { message: 'हम कुकीज़ का उपयोग आपके अनुभव को बेहतर बनाने के लिए करते हैं।', buttonText: 'मैं सहमत हूँ', rejectText: 'मैं असहमत हूँ', policyLink: '/gopaneeyata-neeti', policyText: 'हमारी कुकी पॉलिसी के बारे में और अधिक जानें' },
                    th: { message: 'เราใช้คุกกี้เพื่อปรับปรุงประสบการณ์ของคุณ', buttonText: 'ยอมรับ', rejectText: 'ปฏิเสธ', policyLink: '/nayobai-khwam-s-wan-tua', policyText: 'เรียนรู้เพิ่มเติมเกี่ยวกับนโยบายคุกกี้' },
                    ms: { message: 'Kami menggunakan kuki untuk meningkatkan pengalaman anda.', buttonText: 'Saya Setuju', rejectText: 'Saya Tolak', policyLink: '/dasar-privasi', policyText: 'Ketahui lebih lanjut tentang dasar kuki kami' },
                    id: { message: 'Kami menggunakan cookie untuk meningkatkan pengalaman Anda.', buttonText: 'Saya Setuju', rejectText: 'Saya Tolak', policyLink: '/kebijakan-privasi', policyText: 'Pelajari lebih lanjut tentang kebijakan cookie kami' },
                    tl: { message: 'Gumagamit kami ng cookies upang mapahusay ang iyong karanasan.', buttonText: 'Sumasang-ayon Ako', rejectText: 'Tinatanggihan Ko', policyLink: '/patakaran-sa-privacy', policyText: 'Matuto pa tungkol sa aming patakaran sa cookies' },
                    vi: { message: 'Chúng tôi sử dụng cookie để nâng cao trải nghiệm của bạn.', buttonText: 'Tôi Đồng Ý', rejectText: 'Tôi Từ Chối', policyLink: '/chinh-sach-bao-mat', policyText: 'Tìm hiểu thêm về chính sách cookie của chúng tôi' },
                },
                onAccept() {
                    $(document).cookieManager(customCases, targetPage);
                }
